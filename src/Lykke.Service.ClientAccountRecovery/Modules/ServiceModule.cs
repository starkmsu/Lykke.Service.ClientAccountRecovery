...
namespace Lykke.Service.ClientAccountRecovery.Modules
{
    ...
    {
        private readonly IReloadingManager<ClientAccountRecoverySettings> _settings;
        private readonly ILog _log;
        // NOTE: you can remove it if you don't need to use IServiceCollection extensions to register service specific dependencies
        private readonly IServiceCollection _services;

        public ServiceModule(IReloadingManager<ClientAccountRecoverySettings> settings, ILog log)
        {
            _settings = settings;
            _log = log;
